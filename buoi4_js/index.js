...
document.getElementById("tinhTien").onclick = (event) => {
    ...
    let phanTramGiamGiaLoaiKhach = loaiKhach == "vip" ? 0.1 : loaiKhach == "vanglai" ? 0.05 : null;
    let tienSauGiamGia = tongTien - tongTien * (phanTramGiamGiaLoaiKhach + phanTramGiamGiaSoNguoi);
...
function xetKetQua(diem) {
    console.log(`Kết quả điểm của bạn là ${diem} và thông báo bạn đã ${diem >= 5 ? "Đậu" : "Rớt"}`);
}
